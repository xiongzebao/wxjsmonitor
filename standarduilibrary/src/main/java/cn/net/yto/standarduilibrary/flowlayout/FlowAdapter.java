package cn.net.yto.standarduilibrary.flowlayout;
...
import cn.net.yto.standarduilibrary.R;
...
public class FlowAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(type == 1) return new MyHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.base_flow_item,parent,false));
        else return new MyHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.base_flow_item_one,parent,false));
    }
