package cn.net.yto.module_baselibrary_test.view;
...
import cn.net.yto.module_baselibrary_test.R;
...
public class PasswordInputView extends AppCompatEditText {
    ...
    private int passwordColor = 0xFFff0000;
    ...
    private Paint selDividerPaint = new Paint(ANTI_ALIAS_FLAG);
    ...
    public PasswordInputView(Context context, AttributeSet attrs) {
        ...
        selDividerPaint.setColor(Color.RED);
    }
    ...
    protected void onDraw(Canvas canvas) {
       ...
       // canvas.drawRoundRect(rect, borderRadius, borderRadius, borderPaint);
        ...
        for (int i = 1; i < passwordLength; i++) {
            ...
            canvas.drawLine(x, height, x+height, height, borderPaint);
        }
        ...
        for(int i = 0; i < textLength; i++) {
           ...
           // canvas.drawCircle(cx, cy, passwordWidth, c);
             String drawStr = String.valueOf(text.charAt(i));

            canvas.drawText( drawStr,cx,cy,passwordPaint);


            float x = width * i / passwordLength;
            canvas.drawLine(x, height, x+height, height, selDividerPaint);
        }
    }
